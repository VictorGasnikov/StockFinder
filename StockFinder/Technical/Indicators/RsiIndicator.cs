...
{
    public class RsiIndicator : TechnicalIndicator
    {
...
//        private Graph _downGraph;
        ...
        private readonly List<TechnicalIndicatorItem> _items = new List<TechnicalIndicatorItem>();
//        private readonly List<TechnicalIndicatorItem> _downItems = new List<TechnicalIndicatorItem>();


        public Graph AroonUp => Graphs["Rsi"];
//        public Graph AroonDown => Graphs["AroonDown"];

        public RsiIndicator(string name, int period) : base(name, period)
        {
            _period = period;
        }
...
//            Add(new Graph("AroonDown", _downItems));
        ...
        protected override void CalculateFor(int current)
        {
            ...
            _items.Add(new TechnicalIndicatorItem(date, aroonUp));
